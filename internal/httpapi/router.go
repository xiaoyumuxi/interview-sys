...
func NewRouter(deps Dependencies) http.Handler {
	...
	group.POST("/memory/candidates/:candidate_id/approve", api.approveMemoryCandidate)
	group.POST("/memory/candidates/:candidate_id/reject", api.rejectMemoryCandidate)
	group.POST("/memory/candidates/:candidate_id/edit", api.editMemoryCandidate)
